...
My academic interests include operations research, supply-chain analysis, reliability modelling, and data-driven decision making.

### ✨ Interests

macOS · automation · developer tools · multilingual computing · operations research · data analysis · resilient systems

### 🛠️ Tools

![Python](https://img.shields.io/badge/Python-3776AB?logo=python&logoColor=white&style=for-the-badge)
![SQL](https://img.shields.io/badge/SQL-4479A1?logo=databricks&logoColor=white&style=for-the-badge)
...
- [How to Preview Archives and Disk Images in Finder: Archive Peek for ZIP, DMG, and ISO](https://jingyuan-zheng.github.io/p/archive-peek-macos-quick-look/)
